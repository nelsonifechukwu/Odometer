            ...
            <form method="post" action="">
              <div class="card">
                  ...
                  <form>
                    ...
                    <div class="row">
                      <div class="col-12">
                        <div class="form-group">
                          <label>Email</label>
                          <input type="email" class="form-control" name="driver_email" id="driverEmail"
                    ...
                    <div class="row">
                      <div class="col-12">
                        <div class="form-group">
                          ...
                          <input type="number" class="form-control" name="driver_age" id="driverAge"
                            placeholder="Driver Age" required>
                        </div>
                      </div>
                    </div> 
                    <div class="form-group">
                      <label for="role">Role</label>
                      <select class="form-control" id="role" name="driver_role">
                        <option selected class="text-muted" >Driver role</option>
                ...
                <div class="card-footer">
                  <button type="submit" name="create_drivers" class="btn btn-fill btn-info">Add</button>
                </div>
              </div>
            </form>
          </div>
